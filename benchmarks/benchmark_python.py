...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "FRLT", set_flag = 'py'),
            t, alg = "FRLT", set_flag = 'py'
        )
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "G1", set_flag = 'py'),
            t, alg = "G1", set_flag = 'py'
        )
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "R1", set_flag = 'py'),
            t, alg = "R1", set_flag = 'py'
        )
    # calculation of alg
    t_i = time.time()
