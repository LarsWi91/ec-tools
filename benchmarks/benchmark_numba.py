...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "FRLT", set_flag = 'jit'),
            t, alg = "FRLT", set_flag = 'jit'
        )
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "G1", set_flag = 'jit'),
            t, alg = "G1", set_flag = 'jit'
        )
...
for i in range(0, np.size(N_list)):
    ...
    if i == 0:
        si.semi_integration(
            si.semi_integration(I, t, alg = "R1", set_flag = 'jit'),
            t, alg = "R1", set_flag = 'jit'
        )
